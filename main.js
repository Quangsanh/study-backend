...
app.get('/', (req, res) => {
    res.send(`
        ...
        <p><a href="/page.html">Xem trang HTML tĩnh</a></p>
        <p><a href="/img/my_img.jpg">Xem ảnh tĩnh</a></p>
...
app.listen(Port, () => {
    ...
    console.log(`Trang HTML tĩnh: http://localhost:${Port}/page.html`);
    console.log(`Ảnh tĩnh: http://localhost:${Port}/img/my_img.jpg`);
